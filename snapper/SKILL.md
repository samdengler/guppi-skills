...
### `guppi-snapper capture URL [--output FILE] [--viewport WxH] [--wait SECONDS] [--port PORT]`
...
- `--viewport` / `-v` — viewport dimensions (default: `1400x1092`)
...
guppi-snapper capture https://docs.google.com/spreadsheets/d/ID/edit \
  --output sheet.png --viewport 1400x1092 --wait 8
